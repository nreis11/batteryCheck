...
while 1:
    if time_stamp != last_stamp:
        ...
        if __debug:
            print "Time stamp change detected"
        ...
        for line in lastText:
            ...
            if checkPID(pidVal):
                ...
                if __debug:
                    print "PID " + pidVal + " is not running"
